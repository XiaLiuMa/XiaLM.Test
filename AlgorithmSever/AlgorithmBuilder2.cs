...
{
    public class AlgorithmBuilder2 : ICodecBuilder
    {
        private ICodecDecoding decoding = new AlgorithmDecoding2();
        private ICodecEncoding encoding = new AlgorithmEncoding2();
        ...
        {
            return new AlgorithmBuilder2();
        }
    }

    public class AlgorithmDecoding2 : ICodecDecoding
    {
    ...
    public class AlgorithmEncoding2 : ICodecEncoding
    {
