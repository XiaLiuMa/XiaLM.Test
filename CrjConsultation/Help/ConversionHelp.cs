...
namespace CrjConsultation.Help
{
    ...
    public class ConversionHelp
    {
        ...
        private static ConversionHelp conversionHelp;
        ...
        public static ConversionHelp GetInitialize()
        {
            if (conversionHelp == null)
            {
                lock (lockObj)
                {
                    if (conversionHelp == null)
                    {
                        conversionHelp = new ConversionHelp();
                    }
                }
            }
            return conversionHelp;
        }
